...
date: 'Generated `r lubridate::force_tz(Sys.time(), tzone = "Australia/Sydney")`'
output: 
  html_document: 
    toc: yes
params:
   lexicon_path: "~/git-repos/coedl/warlpiri-2018/src/wlp-lexicon_master.txt"
   CI_ENV: `r Sys.getenv("CI_ENV") == "GITLAB"`
---
...
print_table <- function(df) if(params$IN_SHINY) kable_escaped(df) else datatable(df)
